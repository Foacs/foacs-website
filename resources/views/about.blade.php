...
<div class="ui main container">
    <div class="ui center aligned vertical segment">
        ...
        <p>
            Foacs est une assocation de fait qui à pour but de soutenir le développement d'application numérique libre (<a href="https://opensource.org" target="_blank"><i>(en)</i>open source</a>).<br /> 
